...
class TtCharacterHeightHideCommand(private val plugin: TalekeepersTome) : CommandExecutor, TabCompleter {
    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        ...
        asyncTask(plugin) {
            ...
            val updatedCharacter = characterService.save(character.copy(isHeightHidden = true), player = sender).onFailure {
