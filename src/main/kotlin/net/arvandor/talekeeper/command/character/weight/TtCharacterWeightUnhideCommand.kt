...
class TtCharacterWeightUnhideCommand(private val plugin: TalekeepersTome) : CommandExecutor, TabCompleter {
    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        ...
        asyncTask(plugin) {
            ...
            val updatedCharacter = characterService.save(character.copy(isWeightHidden = false), player = sender).onFailure {
