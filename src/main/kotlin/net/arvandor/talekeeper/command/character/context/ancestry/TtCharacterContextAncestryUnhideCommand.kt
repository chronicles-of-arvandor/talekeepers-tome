...
class TtCharacterContextAncestryUnhideCommand(private val plugin: TalekeepersTome) : CommandExecutor, TabCompleter {
    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        ...
        asyncTask(plugin) {
            ...
            val updatedCtx = characterService.save(ctx.copy(isAncestryHidden = false)).onFailure {
