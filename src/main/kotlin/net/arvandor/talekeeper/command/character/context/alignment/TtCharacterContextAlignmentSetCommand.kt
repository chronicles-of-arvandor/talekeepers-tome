package net.arvandor.talekeeper.command.character.context.alignment
...
class TtCharacterContextAlignmentSetCommand(private val plugin: TalekeepersTome) : CommandExecutor, TabCompleter {
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        ...
        asyncTask(plugin) {
                        ...
                        *TtOrder.values().flatMap { order ->
                            ...
                            listOf(
                                TextComponent(alignment.acronym.padEnd(2)).apply {
                                    ...
                                    clickEvent = ClickEvent(RUN_COMMAND, "/character context alignment set ${alignment.acronym}")
                                },
                                TextComponent(" "),
                            )
                        }.toTypedArray(),
            ...
            val updatedCtx = characterService.save(ctx.copy(alignment = alignment)).onFailure {
