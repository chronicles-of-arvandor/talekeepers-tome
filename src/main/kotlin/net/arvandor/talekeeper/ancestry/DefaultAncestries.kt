...
internal val aasimar = TtAncestry(
    ...
    listOf(
        TtSubAncestry(
            TtSubAncestryId("8f476afa-17e0-479e-859d-cab4024b0f46"),
            "Protector",
            null,
            16,
            160,
        ...
        TtSubAncestry(
            TtSubAncestryId("b64485ee-82f9-452a-bb79-920bb7a16399"),
            "Scourge",
            null,
            16,
            160,
        ...
        TtSubAncestry(
            TtSubAncestryId("1302fa29-e6a7-441f-83c3-2a61d7ad7774"),
            "Fallen",
            null,
            16,
            160,
    ...
    listOf(
        TtAncestryTrait(
            "Size",
            "You are Medium or Small. You choose the size when you select this ancestry.",
        ),
        TtAncestryTrait(
            "Celestial Resistance",
            "You have resistance to necrotic damage and radiant damage.",
...
internal val gnome = TtAncestry(
    ...
    listOf(
        ...
        TtSubAncestry(
            TtSubAncestryId("46e4251d-5412-4bfd-b9fa-e2e00981061c"),
            "Rock",
            null,
            40,
            500,
        ...
        TtSubAncestry(
            TtSubAncestryId("0047bd7e-378d-4cb6-bd03-8b6e8880ad93"),
            "Deep",
            ...
            listOf(
                ...
                TtAncestryTrait(
                    "Size",
                    "A typical svirfneblin stands about 3 to 3-1/2 feet tall and weighs 80 to 120 pounds. Your size is Small.",
                ),
                TtAncestryTrait(
                    "Gnome Cunning",
                    "You have advantage on all Intelligence, Wisdom and Charisma saving throws against magic.",
