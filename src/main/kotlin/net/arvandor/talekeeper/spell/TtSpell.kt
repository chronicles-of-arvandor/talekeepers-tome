...
data class TtSpell(
    ...
    val scalingLevelDice: TtSpellScalingLevelDice,
    ...
    companion object {
        ...
        fun deserialize(serialized: Map<String, Any>) = TtSpell(
            ...
            serialized["srd"] as Boolean,
            serialized["basic-rules"] as Boolean,
            serialized["level"] as Int,
            (serialized["school"] as String).let(TtSpellSchool::valueOf),
            serialized["time"] as TtSpellTime,
            ...
            serialized["scaling-level-dice"] as TtSpellScalingLevelDice,
